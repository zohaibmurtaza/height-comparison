...
const NavBar = ({ className }: { className?: string }) => {
  ...
  return (
    <nav
      className={`md:h-full w-full bg-white rounded-2xl shadow-sm p-1 pb-0 md:pb-0 md:space-y-4 border border-gray-200 sticky top-2 flex flex-row justify-start items-between z-20 overflow-x-auto min-h-fit ${className}`}
    >
